...
export default function NotFoundPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-full py-10 animate-fadeIn">
      <StyledWrapper>
      ...
      <div className="text-center mt-6 space-y-3">
        <p className="text-secondary text-sm">Oops! The page you're looking for doesn't exist.</p>
        <div className="flex gap-3 justify-center">
          <button
            onClick={() => navigate(-1)}
            className="px-4 py-2 text-sm font-semibold btn-secondary rounded-lg"
          >
            Go Back
          </button>
          <button
