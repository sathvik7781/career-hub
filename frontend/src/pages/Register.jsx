...
export default function Register() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      // Restore resend cooldown if OTP was sent recently
      if (parsed.otpSentAt) {
  ...
  useEffect(() => {
    if (step === "otp" && !formData.email) {
      setStep("email");
    }

    if (step === "role" && !formData.email) {
      setStep("email");
    }
  }, [step, formData.email]);
  ...
  async function handleSendOtp(e) {
    ...
    try {
      ...
      await axios.post(`${API_URL}/auth/register/request-otp`, {
        email: formData.email,
      });
  ...
  async function handleVerifyOtp(e) {
    ...
    try {
      ...
      await axios.post(`${API_URL}/auth/register/verify-otp`, {
        email: formData.email,
